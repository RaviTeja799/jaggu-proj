...
class LegalBERTClassifier:
    ...
    def __init__(self, model_name: str = "nlpaueb/legal-bert-base-uncased"):
        ...
        # Define regulatory clause types for compliance checking
        # These align with GDPR, HIPAA, SOX, and CCPA requirements
        self.clause_types = [
            "Data Processing",
        ...
        logger.info(f"Initialized with {len(self.clause_types)} regulatory clause types")
        ...
        self.clause_keywords = {
            ...
            "Data Processing": [
                ...
                "data processor", "processing activities", "lawful basis", "purpose limitation"
            ],
            "Sub-processor Authorization": [
            ...
            "Permitted Uses and Disclosures": [
                ...
                "legitimate interest", "specific purpose"
            ],
            "Other": [
                "agreement", "contract", "terms", "conditions", "general",
                "miscellaneous", "definitions", "parties", "effective date"
            ]
        }
        
        logger.info(f"Loaded keyword dictionaries for {len(self.clause_keywords)} clause types")
